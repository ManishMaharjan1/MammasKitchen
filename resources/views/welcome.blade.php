    ...
    <head>
        ...
        <style>
            ...
            @foreach($aboutuses as $aboutus)
                .about-bg
                    {
                        background: url({{ asset('uploads/item/' .$aboutus->image) }});
            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{'/'}}">
                        ...
                        <img id="logo" src="uploads/logo/{{$logo->image}}" class="logo img-responsive">
                        @endforeach
                    </a>
                </div>
                            ...
                            <ul id="menu-pricing" class="menu-price"> 
                                @foreach($items as $item)
                                    <li class="item" id="{{ $item->category->slug }}">
                                        ...
                                        <h2 class="white">Rs  {{ $item->price }}</h2>
                                    </li>
                                @endforeach
                            </ul>
                                ...
                                <form class="reservation-form" method="post" action="{{route('reservation.reserve')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="dateandtime" id="datetimepicker1" autocomplete="off" placeholder=" &#xf017;  Time">
                                            </div>
                                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <ul class="center-block">
                                ...
                                <li><a href="https://www.youtube.com/" class="link"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="#">Mamma's Kitchen.</a> Developed by <a href="https://github.com/ManishMaharjan1?tab=repositories"  target="_blank">ManishMaharjan</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            $(document).ready(function(){
                ...
                $(window).scroll(function() {
                    if ($(document).scrollTop() > 50) {
                        ...
                        $("#logo").attr("src", "uploads/logo/{{$logo->image}}");
                    }
                });
            });
        </script>

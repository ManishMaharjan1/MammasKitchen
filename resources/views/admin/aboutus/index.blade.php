                            ...
                            <table id="table" class="table"  cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    @foreach($aboutuses as $key=>$aboutus)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td>{!! str_limit($aboutus->description,50) !!}</td>
                                            <td><img class="img-responsive img-thumbnail" src="{{ asset('uploads/item/'.$aboutus->image) }}" style="height: 80px; width: 120px" alt=""></td>
